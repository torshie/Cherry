...
enum MiscConst {
	kCoeffTokenCount = 12, kSegmentCount = 4, kBlockWidth = 16,
	kEndOfCoeff = 0x7fff
};
...
const static TreeIndex kSegmentMappingTree[] = {
	2, 4, 0, -1, -2, -3
};

const static TreeIndex kKeyFrameLumaModeTree[] = {
	-kDummyLumaMode, 2, 4, 6,
	-kAverageMode, -kVerticalMode, -kHorizontalMode, -kTrueMotionMode
};

const static Probability
kKeyFrameLumaModeProbability[kLumaModeCount - 1] = {
	145, 156, 163, 128
};

const static TreeIndex kCoeffTokenTree[] = {
	-11, 2, 0, 4, -1, 6, 8, 12, -2, 10, -3, -4, 14, 16, -5, -6, 18, 20,
	-7, -8, -9, -10
};

const static TreeIndex kSmallTokenTree[] = {
	0, 2, -1, 4, 6, 10, -2, 8, -3, -4, 12, 14, -5, -6, 16, 18,
	-7, -8, -9, -10
};

const static TreeIndex kSubmodeTree[] = {
	-kAverageSubmode, 2,
		-kTrueMotionSubmode, 4,
			-kVerticalSubmode, 6,
			8, 12,
				-kHorizontalSubmode, 10,
				-kRightDownSubmode, -kVerticalRightSubmode,
			-kLeftDownSubmode, 14,
				-kVerticalLeftSubmode, 16,
				-kHorizontalDownSubmode, -kHorizontalUpSubmode
};

const static TreeIndex kChromaModeTree[] = {
	-kAverageMode, 2,
	-kVerticalMode, 4,
	-kHorizontalMode, -kTrueMotionMode
};

const static Probability kKeyFrameChromaModeProbability[] = {
	142, 114, 183
};

const static Probability kDefaultCoeff[4][8][3][kCoeffTokenCount - 1] = {
	{ /* Block Type ( 0 ) */
		{ /* Coeff Band ( 0 )*/
...
const static Probability
kCoeffUpdateProbability[4][8][3][kCoeffTokenCount - 1] = {
	{
		{
...
const static Probability
kKeyFrameSubmodeProbability
[kSubmodeCount][kSubmodeCount][kSubmodeCount - 1] = {
	{
