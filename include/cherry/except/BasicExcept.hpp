#ifndef _CHERRY_EXCEPT_UNKNOWN_EXCEPTION_HPP_INCLUDED_
#define _CHERRY_EXCEPT_UNKNOWN_EXCEPTION_HPP_INCLUDED_
...
#endif // _CHERRY_EXCEPT_UNKNOWN_EXCEPTION_HPP_INCLUDED_
